...
const STANDARD_FIELDS: Record<string, { field: string; aliases: string[]; type: string; required: boolean }[]> = {
  ...
  BUSINESS_ORDER: [
    { field: 'order_no', aliases: ['订单编号', '订单号', 'order_no', 'order_id', '订单流水号'], type: 'string', required: true },
    { field: 'order_type', aliases: ['订单类型', 'order_type', '类型'], type: 'string', required: false },
    { field: 'pay_method', aliases: ['支付方式', 'pay_method', '付款方式'], type: 'string', required: false },
    { field: 'channel_name', aliases: ['渠道名称', 'channel_name', '渠道', '服务商'], type: 'string', required: false },
    { field: 'customer_phone', aliases: ['顾客手机号', '手机号', 'phone', 'customer_phone'], type: 'string', required: false },
    { field: 'customer_name', aliases: ['顾客姓名', '姓名', 'customer_name', '客户姓名'], type: 'string', required: false },
    { field: 'order_amount', aliases: ['订单金额', 'order_amount', '金额', '交易金额'], type: 'amount', required: true },
    { field: 'received_amount', aliases: ['实收金额', 'received_amount', '实收'], type: 'amount', required: false },
    { field: 'paid_amount', aliases: ['实付金额', 'paid_amount', '实付'], type: 'amount', required: false },
    { field: 'channel_fee', aliases: ['通道手续费', 'channel_fee', '手续费', '费率'], type: 'amount', required: false },
    { field: 'order_status', aliases: ['订单状态', 'order_status', '状态', '交易状态'], type: 'string', required: false },
    { field: 'pay_serial_no', aliases: ['支付流水号', 'pay_serial_no', '流水号', 'serial_no', '原交易流水号', 'orig_serial_no'], type: 'string', required: false },
    { field: 'orig_serial_no', aliases: ['原交易流水号', 'orig_serial_no', '原始流水号'], type: 'string', required: false },
    { field: 'trans_date', aliases: ['交易日期', 'trans_date', '日期'], type: 'date', required: false },
  ],
};
